...
abstract final class NusUuids {
  ...
  static final Guid rxCharacteristic = Guid(
...
abstract final class ZswatchExtendedUuids {
  ...
  static final Guid service = Guid('12345678-1234-5678-1234-56789abcdef0');
...
abstract final class HeartRateUuids {
  ...
  static final Guid bodySensorLocation = Guid(
...
abstract final class BatteryUuids {
  ...
  static final Guid service = Guid('0000180f-0000-1000-8000-00805f9b34fb');

  /// Battery Level Characteristic
  static final Guid level = Guid('00002a19-0000-1000-8000-00805f9b34fb');
}

/// Standard Device Information Service UUIDs (GATT 0x180A)
abstract final class DeviceInfoUuids {
  /// Device Information Service UUID
  static final Guid service = Guid('0000180a-0000-1000-8000-00805f9b34fb');

  /// Manufacturer Name String
  static final Guid manufacturerName = Guid(
    '00002a29-0000-1000-8000-00805f9b34fb',
  );

  /// Model Number String
  static final Guid modelNumber = Guid('00002a24-0000-1000-8000-00805f9b34fb');
...
abstract final class McumgrUuids {
  /// SMP Service UUID
  static final Guid service = Guid('8d53dc1d-1db7-4cd3-868b-8a527460aa84');

  /// SMP Characteristic (bidirectional)
  static final Guid characteristic = Guid(
...
abstract final class SensorServiceUuids {
  ...
  static final Guid service = Guid('e6c90001-2a76-4094-917e-9af7d7a7a5b1');

  /// Accelerometer Data Characteristic
  static final Guid accelerometer = Guid(
    'e6c90002-2a76-4094-917e-9af7d7a7a5b1',
  );

  /// Gyroscope Data Characteristic
  static final Guid gyroscope = Guid('e6c90003-2a76-4094-917e-9af7d7a7a5b1');

  /// PPG (Photoplethysmography) Data Characteristic
  static final Guid ppg = Guid('e6c90004-2a76-4094-917e-9af7d7a7a5b1');

  /// Temperature Data Characteristic
  static final Guid temperature = Guid('e6c90005-2a76-4094-917e-9af7d7a7a5b1');
}
